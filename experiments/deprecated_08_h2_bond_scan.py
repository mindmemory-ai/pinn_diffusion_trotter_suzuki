"""H2 bond-length scan: generate Hamiltonians, run closed-loop, record results."""
...
def _run_single_bond(
    ...
    *,
    ...
    hamiltonian = generate_h2_hamiltonian(bond_length=bond_length, basis=basis)
...
def main() -> None:
    ...
    parser.add_argument("--bond-start", type=float, default=0.5)
    parser.add_argument("--bond-end", type=float, default=3.0)
    ...
    parser.add_argument("--output", default="experiments/benchmark_results/h2_bond_scan.json")
    ...
    print(f"Saved H2 scan results to {out_path}")
